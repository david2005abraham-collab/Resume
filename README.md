...
```
├── index.html                  # Semantic, SEO-friendly HTML5 structure
├── David_Abraham_Resume.pdf    # Direct download resume file
├── assets/                     # Profile photo, avatar, and SVG favicon
├── css/
│   ├── styles.css              # Core design tokens and responsive layout
│   └── animations.css          # Keyframes and scroll reveal animations
├── js/
│   ├── projects-data.js        # Easy-to-edit projects and skills configuration
│   └── main.js                 # Dynamic rendering, filtering, form & copy actions
...
1. Double-click `index.html` to open directly in your web browser.
...
1. Push to GitHub:
   ...
   ```
2. In GitHub repository settings, go to **Pages** > select **Deploy from a branch** (`main` / root) to publish live instantly!
